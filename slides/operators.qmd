...
- Read through the document after class. This is meant to be a reference, and ideally, you should be able to understand every line of code. If there is something you do not understand please Slack or email us with questions. You can also ask in the following class (you're probably not the only one with the same question!). 
